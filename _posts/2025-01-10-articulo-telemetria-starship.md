...
This is the following classes of the code and this is how it works:
...
2. **Function read_speed_and_altitude_from_video**:
   ...
   - **Process**:
     ...
     - Defines profiles for different spacecraft, specifying coordinates and dimensions for regions in the video frames where speed, altitude, and time information can be found.
...
Using this tool we can do a lot of type of charts but we are very limited, that's why I decided to make a website using technologies like React to make a simple website to display the data (This website is still in development)
...
- Working with the tiny fuel pixels, they were very small and the noise made it impossible for me to detect them correctly.
